...
module.exports = class walletNode extends EventEmitter {
  constructor (nodeAddress, readyCallback) {
    ...
    const packageDefinition = protoLoader.loadSync(__dirname + '/../protos/pugdagwalletd.proto', {
      keepCase: true,
      longs: String,
      enums: String,
      defaults: true,
      oneofs: true
		...
		const { pugdagwalletd } = gRPC.loadPackageDefinition(packageDefinition).pugdagwalletd

    this._client = new pugdagwalletd(nodeAddress, gRPC.credentials.createInsecure(), {  
